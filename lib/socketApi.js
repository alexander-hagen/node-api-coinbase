...
module.exports = {
  marketApi: function(keys) { return new CoinbaseSocket(marketUrl, keys); },
...
CoinbaseSocket.prototype.subscribeHeartbeats = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#heartbeats-channel
...
CoinbaseSocket.prototype.subscribeStatus = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#status-channel
  const reqID="id"+(++this.socket._id);
  const options={
    type: "subscribe",
    product_ids: symbols,
...
CoinbaseSocket.prototype.unsubscribeStatus = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#status-channel
  const reqID="id"+(++this.socket._id);
  const options={
    type: "unsubscribe",
    product_ids: symbols,
...
CoinbaseSocket.prototype.subscribeTicker = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#ticker-channel
  const reqID="id"+(++this.socket._id);
  const options={
    type: "subscribe",
    product_ids: symbols,
...
CoinbaseSocket.prototype.unsubscribeTicker = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#ticker-channel
  const reqID="id"+(++this.socket._id);
  const options={
    type: "unsubscribe",
    product_ids: symbols,
...
CoinbaseSocket.prototype.subscribeTickerBatch = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#ticker-batch-channel
  const reqID="id"+(++this.socket._id);
  const options={
    type: "subscribe",
    product_ids: symbols,
...
CoinbaseSocket.prototype.unsubscribeTickerBatch = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#ticker-batch-channel
  const reqID="id"+(++this.socket._id);
  const options={
    type: "unsubscribe",
    product_ids: symbols,
...
CoinbaseSocket.prototype.subscribeOrderbook = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#level2-channel
  const reqID="id"+(++this.socket._id);
  const options={
    type: "subscribe",
    product_ids: symbols,
...
CoinbaseSocket.prototype.unsubscribeOrderbook = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#level2-channel
  const reqID="id"+(++this.socket._id);
  const options={
    type: "unsubscribe",
    product_ids: symbols,
...
CoinbaseSocket.prototype.subscribeTrades = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#market-trades-channel
  const reqID="id"+(++this.socket._id);
  const options={
    type: "subscribe",
    product_ids: symbols,
...
CoinbaseSocket.prototype.unsubscribeTrades = async function(symbols) { // https://docs.cdp.coinbase.com/advanced-trade/docs/ws-channels#market-trades-channel
  const reqID="id"+(++this.socket._id);
  const options={
    type: "unsubscribe",
    product_ids: symbols,
