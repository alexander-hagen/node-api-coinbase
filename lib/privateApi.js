...
CoinbasePrivate.prototype.query = function(options) {
...
CoinbasePrivate.prototype.getQuery = function(path, query) {
  var options = {
    method: "GET",
...
CoinbasePrivate.prototype.otherQuery = function(method, path, query) {
  var options = {
    method: method,
    url: this.endPoint + path,
    body: query,
